...
select
    ...
    customer_since
from customer
where customer_since between "2018-12-31" and "2020-01-01";
...
select
    ...
    customer_since
from customer
where customer_since > "2019-01-01" and
...
select
    ...
    last_name
from customer
where first_name = "Tadeo"
and last_name = "Divine";
-- 854
